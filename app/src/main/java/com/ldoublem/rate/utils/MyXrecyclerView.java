...
//        return false;
    ...
    public void setHeadTextColor(int color) {
        ...
        ((TextView) mRefreshHeader.findViewById(com.jcodecraeer.xrecyclerview.R.id.last_refresh_time)).setTextColor(color);

        ((TextView) mRefreshHeader.findViewById(com.jcodecraeer.xrecyclerview.R.id.refresh_status_textview)).setTextColor(color);
